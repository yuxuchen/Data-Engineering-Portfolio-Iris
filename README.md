# 💡 Ares's Data Engineering Portfolio

## 👋 About Me  
Hi, I'm Ares, a Data Engineer with expertise in cloud-based data pipelines, ETL, and big data analytics. I have hands-on experience working with **AWS, Azure, and GCP**, developing scalable data solutions for real-time and batch processing.
...
### **🚖 [GCP NYC Taxi Analytics Project](./GCP-NYC-Taxi-Analytics-Project)**
- Processed **37M+ records** of **NYC TLC Trip Data** using **BigQuery**.
- Built an **ETL pipeline** with **Mage** on **Google Compute Engine**.
- Generated business intelligence reports in **Looker** to analyze ride frequency, trip duration, and fare trends.
...
- **Data Warehouses:** BigQuery, Redshift, Azure Synapse  
